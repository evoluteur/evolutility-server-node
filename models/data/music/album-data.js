module.exports = [
  {
    ...
    length: "73:05",
    description:
      "From one of the most recognized voices in the world of sacred chant comes a heartfelt collection of music for the soul: The Essential Snatam Kaur. Immersed in the kundalini tradition since birth, Snatam—who has sold more than 350,000 records to date—has toured the world offering inspiring and uplifting music to sold-out crowds. With a gift for transforming Gurmukhi mantras and Eastern traditional chants into contemporary sound that appeals to a wide variety of listeners, Snatam takes us on an inner journey through her favorite selections for healing, strength, and peace.",
  },
  {
    id: 2,
    title: "Beloved",
    ...
    length: "71:24",
    description:
      "A love song to the heart of exquisite depth and lyrical sensitivity, featuring angelic vocals of unparalleled beauty and the transcendent sound of crystal singing bowls; tender, gentle, uplifting, divinely inspired healing music.",
  },
  {
    id: 3,
    title: "Beloved",
    ...
    length: "60:23",
    description:
      "Beloved is a love song to the heart. Tender, joyful, gentle, and breathtakingly beautiful, the music of Beloved is a healing balm for the soul that will lift your spirit and carry you on waves of love into the arms of the Divine./n/n" +
  ...
  },
  {
    ...
    length: "52:21",
    description:
      "The songs in the album are all tamil devotional mantras sang with modern music, remixed by Naid.",
  },
];
